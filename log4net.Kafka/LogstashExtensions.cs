...
namespace log4net.Kafka
{
    internal static class LogstashExtensions
    {
        ...
        public static string ToJson(this LogstashEvent evt)
        {
            ...
            .WriteString(nameof(LogstashEvent.service), evt.service).Append(",")
            ...
            .WriteString(nameof(LogstashEvent.user), evt.user).Append(",")
            .WriteString(nameof(LogstashEvent.ip), evt.ip).Append(",")
            .WriteMessage(evt)
            .Append("}");
